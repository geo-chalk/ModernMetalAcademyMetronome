...
const Info = () => {
    ...
    const cycles = [
        {
            title: "1. Exercise | Cycle One",
            subtitle: "Top speed minus 20 BPM",
            details: "2 min burst | +2 BPM every 10s"
        },
        {
            title: "2. Exercise | Cycle Two",
            subtitle: "Cycle One start + 5 BPM",
            details: "2 min burst | +2 BPM every 10s"
        },
        {
            title: "3. Exercise | Cycle Three",
            subtitle: "Cycle Two start + 5 BPM",
            details: "3 min burst | +2 BPM every 10s"
        }
    ];
    ...
    return (
        <div className="space-y-6 pt-0 pb-8 overflow-y-auto no-scrollbar touch-pan-y">
            ...
            {/* Main Tip */}
            <section>
                <h2 className="text-white text-[16px] font-black tracking-widest uppercase mb-2 opacity-100"
                    style={k2dStack}>
                    Find Your Top Speed
                </h2>
            ...
            <div className="space-y-4 pt-2">
                {cycles.map((cycle, i) => (
                    <div key={i} className="bg-white/[0.03] p-4 rounded-md border border-white/5">
                        ...
                        <p className="text-[#FF820C] text-[14px] tracking-wider mb-2"
                           style={k2dStack}>{cycle.subtitle}</p>
            ...
            <div className="pt-4 border-t border-white/5">
                ...
                <div className="grid grid-cols-1 gap-2">
                    {shortcuts.map((s, i) => (
                        <div key={i}
                             className="flex justify-between items-center text-[14px] font-mono tracking-tighter">
